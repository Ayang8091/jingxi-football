...
window.JX_DATA = (function () {
  ...
  var model = {
    ...
    formula: {
      ...
      tau: 'τ(x,y) = 1−ρ·λh·λa  (x=y=0) ｜ 1+ρ·λh  (x=0,y=1) ｜ 1+ρ·λa  (x=1,y=0) ｜ 1−ρ  (x=y=1) ｜ 1  (其余)',
  ...
  var records = {
    ...
    weekly: [
      { w: '6/22-6/28', picks: 98, hit: 60, rate: 0.612, roi: 0.028 },
      { w: '6/29-7/5', picks: 104, hit: 66, rate: 0.635, roi: 0.061 },
      { w: '7/6-7/12', picks: 92, hit: 53, rate: 0.576, roi: -0.048 },
      { w: '7/13-7/19', picks: 108, hit: 71, rate: 0.657, roi: 0.096 },
      { w: '7/20-7/26', picks: 101, hit: 64, rate: 0.634, roi: 0.052 },
      { w: '7/27-8/2', picks: 96, hit: 61, rate: 0.635, roi: 0.074 },
      { w: '8/3-8/9', picks: 105, hit: 63, rate: 0.600, roi: 0.011 },
      { w: '8/10-8/16', picks: 112, hit: 74, rate: 0.661, roi: 0.118 },
      { w: '8/17-8/23', picks: 99, hit: 56, rate: 0.566, roi: -0.067 },
      { w: '8/24-8/30', picks: 107, hit: 70, rate: 0.654, roi: 0.089 },
      { w: '8/31-9/6', picks: 103, hit: 68, rate: 0.660, roi: 0.083 },
      { w: '9/7-9/13', picks: 106, hit: 66, rate: 0.623, roi: 0.044 }
    ],
    byPlay: [
